...
# sub-21050_ses-1_task-fracback_space-MNI152NLin6Asym_res-2_desc-brain_mask.nii.gz
# or sub-20259_ses-1_task-fracback_acq-VARIANTObliquity_space-MNI152NLin6Asym_res-2_desc-brain_mask.nii.gz
mask_pattern = (
    f"sub-{sub_id}/ses-1/func/"
    f"sub-{sub_id}_ses-1_task-{task_label}*"
...
for model_type in MODEL_TYPES:
    ...
    out_dir = Path(
        f"/cbica/projects/grmpy/code/analysis/results/first-level/fracback-{model_type}"
    )
