#!/bin/bash
# Upload /cbica/projects/grmpy/data/derivatives/aslprep to OpenNeuro from CUBIC.
#
# Run inside a screen session as the grmpy project user:
#     screen -S onupload
#     bash /cbica/projects/grmpy/code/openneuro/aslprep/upload-bids.sh
...
DATA=/cbica/projects/grmpy/data/derivatives/aslprep
OUT=/cbica/projects/grmpy/code/openneuro/aslprep
