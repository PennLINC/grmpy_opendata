...
babs init \
     --container-ds ${project_root}/data/BABS/apptainer-datasets/aslprep-25-0-0-ds \
     --container-name aslprep-25-0-0 \
     --container-config ${project_root}/code/curation/05_babs/aslprep-25-0-0.yaml \
