...
#SBATCH --output=/cbica/projects/grmpy/code/curation/04_cubids_curation/v5/cubids_apply_%A.out
#SBATCH --error=/cbica/projects/grmpy/code/curation/04_cubids_curation/v5/cubids_apply_%A.err
#SBATCH --ntasks=1
...
PATH=$PATH:/cbica/projects/grmpy/code/curation/04_cubids_curation/v5/
mamba activate cubids

# Run CuBIDS apply
cd /cbica/projects/grmpy/data/bids_datalad/
/cbica/projects/grmpy/miniforge3/envs/cubids/bin/cubids apply /cbica/projects/grmpy/data/bids_datalad /cbica/projects/grmpy/code/curation/04_cubids_curation/v4/v4_summary_edited.tsv /cbica/projects/grmpy/code/curation/04_cubids_curation/v4/v4_files.tsv /cbica/projects/grmpy/code/curation/04_cubids_curation/v5/v5 --use-datalad
